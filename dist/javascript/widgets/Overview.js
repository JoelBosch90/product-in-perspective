...
class Overview extends BaseElement {
  ...
  constructor(parent, options = {}) {
    ...
    if (options.title) this.title(options.title); // Add the center class to the overview if requested.
  ...
  remove() {
    ...
    if (this._cards) for (const card in this._cards) card.remove(); // Remove all references.

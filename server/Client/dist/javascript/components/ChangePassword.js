...
/**
 *  The definition of the ChangePassword class component that can be used to load
...
class ChangePassword extends BaseElement {
  /**
...
} // Export the ChangePassword class so it can be imported elsewhere.

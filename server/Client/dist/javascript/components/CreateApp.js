...
/**
 *  The definition of the CreateApp class component that can be used to load
...
class CreateApp extends BaseElement {
  /**
  ...
  constructor(parent, options = {}) {
    ...
    this._container = document.createElement("div"); // Create a form for creating an app.
...
} // Export the CreateApp class so it can be imported elsewhere.

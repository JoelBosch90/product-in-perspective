...
/**
 *  The definition of the CreateProduct class component that can be used to load
...
class CreateProduct extends BaseElement {
  /**
...
} // Export the CreateProduct class so it can be imported elsewhere.

...
/**
 *  The definition of the PasswordChanger class component that can be used to load
 ...
 *  Javascript classes.
 */
class PasswordChanger extends BaseElement {
...
// Export the PasswordChanger class so it can be imported elsewhere.

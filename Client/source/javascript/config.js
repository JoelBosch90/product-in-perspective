...
// Depending on the environment that we're running, we might want to call the
...
CONFIG.storageUrl = 'http://localhost:9000/models';

// Export the CONFIG namespace so it can be imported elsewhere.
export { CONFIG };
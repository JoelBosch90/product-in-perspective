...
class Modal extends BaseElement {
  ...
  constructor(options = {}) {
    ...
    super(); // Create a container for the modal. This will act as the backdrop for the
    // modal.

    this._container = document.createElement("div");

    this._container.classList.add("modal"); // Create a separate container for the message.
